...
urlpatterns = patterns(
    ...
    (r'^unsubscribe/(?P<unsubscribe_auth>.+)/$', 'weatherapp.views.unsubscribe'),
    (r'^preferences/(?P<pref_auth>.+)/$', 'weatherapp.views.preferences'),
    (r'^confirm_pref/(?P<pref_auth>.+)/$', 'weatherapp.views.confirm_pref'),
    (r'^fingerprint_not_found/(?P<fingerprint>.+)/$', 'weatherapp.views.fingerprint_not_found'),
    (r'^error/(?P<error_type>[a-z_]+)/(?P<key>.+)/$', 'weatherapp.views.error'),
    (r'^resend_conf/(?P<confirm_auth>.+)/$', 'weatherapp.views.resend_conf'),
    (r'^notification_info/$', 'weatherapp.views.notification_info'),
    (r'^router_name_lookup/$', 'weatherapp.views.router_name_lookup'),
    (r'^router_fingerprint_lookup/$', 'weatherapp.views.router_fingerprint_lookup'),
