...
@var _FINGERPRINT_NOT_FOUND: The url pattern for the
    fingerprint not found page.
...
@var _RESEND_CONF: The url pattern for the page displayed after the
    confirmation needed email is resent.
